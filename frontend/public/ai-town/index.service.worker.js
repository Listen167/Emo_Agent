...
/** @type {string} */
const CACHE_PREFIX = 'Helloagents-AI-Town-sw-cache-';
...
/** @type {string[]} */
const CACHED_FILES = ["index.html","index.js","index.wasm","index.side.wasm","index.pck","index.png","index.icon.png","index.apple-touch-icon.png","index.audio.worklet.js","index.audio.position.worklet.js","index.service.worker.js"];
